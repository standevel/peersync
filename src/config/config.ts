...
export default () => ({
    ...
    MONGODB_URI: process.env.MONGODB_URI || 'mongodb+srv://peer_user:sNbeRPv0Gt3aIHZ6@cluster0.vrx0p3m.mongodb.net/peersync?retryWrites=true&w=majority',//'mongodb://127.0.0.1/peersync',
